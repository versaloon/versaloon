...
#define CUR_TARGET_STRING			NUC100_STRING
...
struct program_functions_t nuc100_program_functions;

VSS_HANDLER(nuc100_help)
{
	VSS_CHECK_ARGC(1);
...
const struct vss_cmd_t nuc100_notifier[] =
{
	VSS_CMD(	"help",
