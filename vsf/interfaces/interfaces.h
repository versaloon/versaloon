...
struct interface_usbd_callback_t
{
	...
	vsf_err_t (*on_control_status)(void*);
...
#define CORE_USBD_CONTROL_STATUS(m)		__CONNECT(m, _usbd_control_status)
...
vsf_err_t CORE_USBD_CONTROL_STATUS(__TARGET_CHIP__)(void);
